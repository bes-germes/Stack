...
public:
    ...
    size_t size() const;
    float loadFactor();//size:capacity = (lowfactor > 1)? capacity *coef || lowfactor <= 1/coef^2
...
MyVector sortedSquares(const MyVector& vec, bool SortedStrategy = true);// true - по возрастанию. false - по убыванию.
